...
def prepare_data():
    ...
    image_path = "/root/code_dir/ControlNet_Seg/datasets/category_zero_test/photo/motorcycle"
    sketch = "/root/code_dir/ControlNet_Seg/datasets/category_zero_test_3/sketch/motorcycle"
    anno_path = "/root/code_dir/ControlNet_Seg/datasets/category_zero_test/anno_npy/motorcycle"
    ...
    images_path,sketchs_path,label_path = get_one_category_file_2(image_path,sketch,anno_path)
...
def evaluation(args, models):
    ...
    with open("/root/code_dir/ControlNet_Seg/exp_result/exp8/table/motorcycle/metric3.txt","a") as fp:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_dir',type=str,default="/root/code_dir/ControlNet_Seg/checkpoint/exp8/table")
    parser.add_argument('--save_dir',type=str,default="/root/code_dir/ControlNet_Seg/exp_result/exp8/table/motorcycle")
